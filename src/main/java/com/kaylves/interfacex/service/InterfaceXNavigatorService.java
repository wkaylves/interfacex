...
import com.kaylves.interfacex.common.constants.ToolkitIcons;
import com.kaylves.interfacex.module.navigator.InterfaceXNavigatorPanel;
import com.kaylves.interfacex.module.navigator.InterfaceXNavigatorState;
import com.kaylves.interfacex.module.navigator.InterfaceXSimpleTreeStructure;
...
@Slf4j
public final class InterfaceXNavigatorService implements PersistentStateComponent<InterfaceXNavigatorState>{

    public static final Logger LOG = Logger.getInstance(InterfaceXNavigatorService.class);
    ...
    public InterfaceXNavigatorService(Project project) {
        this.project = project;
    }


    public static InterfaceXNavigatorService getInstance(Project project) {
        return project.getService(InterfaceXNavigatorService.class);
    }
