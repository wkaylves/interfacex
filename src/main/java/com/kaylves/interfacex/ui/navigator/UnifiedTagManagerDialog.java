...
public class UnifiedTagManagerDialog extends JDialog {
    ...
    private void loadTags() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "加载标签失败: " + e.getMessage(), 
    ...
    private void updateDetailArea() {
        ...
        try {
            ...
            List<TagEntity> tags = tagDao.findByTagName(projectPath, tagName);
            ...
            log.error("Failed to load tag details", e);
            detailArea.setText("加载详情失败: " + e.getMessage());
        }
    }
    ...
    private void addNewTag() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "添加标签失败: " + e.getMessage(), 
                "错误", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void applyToCurrentInterface() {
        ...
        try {
            ...
            // 检查是否已存在
            List<TagEntity> existingTags = tagDao.findByInterface(
                projectPath,
            ...
            log.error("Failed to apply tag", e);
            JOptionPane.showMessageDialog(this, "应用标签失败: " + e.getMessage(), 
                "错误", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void removeFromCurrentInterface() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "移除标签失败: " + e.getMessage(), 
                "错误", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void deleteSelectedTag() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "删除标签失败: " + e.getMessage(), 
                "错误", JOptionPane.ERROR_MESSAGE);
        }
    }
