package com.kaylves.interfacex.utils.spring;

import com.kaylves.interfacex.common.annotations.mission.MissionClientMethodAnnotation;
import com.kaylves.interfacex.common.annotations.http.SpringRequestMethodAnnotation;
...
public class SpringRequestMappingAnnotationHelper implements RestSupportedAnnotationHelper {
     ...
     * @return
     */
    public static List<RequestPath> getSpringAnnotationRequestPaths(PsiClass psiClass) {
        ...
        if (requestMappingAnnotation != null) {
            ...
            if (superClass != null && !superClass.getQualifiedName().equals("java.lang.Object")) {
                list = getSpringAnnotationRequestPaths(superClass);
            } else {
    ...
    public static RequestPath[] getMissionRequestPaths(PsiMethod psiMethod) {
    ...
    public static RequestPath[] getSpringAnnotationRequestPaths(PsiMethod psiMethod) {
        PsiAnnotation[] annotations = psiMethod.getModifierList().getAnnotations();
    ...
    public static String getOneRequestMappingPath(PsiClass psiClass) {
        ...
        String path = null;
        if (annotation != null) {
            path = SpringRequestMappingAnnotationHelper.getRequestMappingValue(annotation);
        }
    ...
    public static String getOneRequestMappingPath(PsiMethod psiMethod) {
        ...
        List<SpringRequestMethodAnnotation> springRequestAnnotations = Arrays.stream(SpringRequestMethodAnnotation.values()).filter(annotation -> psiMethod.getModifierList().findAnnotation(annotation.getQualifiedName()) != null).collect(Collectors.toList());
        ...
        if (requestAnnotation != null) {
            ...
            mappingPath = SpringRequestMappingAnnotationHelper.getRequestMappingValue(annotation);
        } else {
