...
public class ToolkitUtil {
    ...
    public static void runWhenInitialized(final Project project, final Runnable r) {
        ...
        if (!project.isInitialized()) {
            StartupManager.getInstance(project).runWhenProjectIsInitialized(() -> DumbService.getInstance(project).runWhenSmart(r));
            return;
        }
    ...
    public static String removeRedundancyMarkup(String pattern) {
        ...
        String hostAndPortRegex = "(http(s?)://)?" + "( " + "([a-zA-Z0-9]([a-zA-Z0-9\\\\-]{0,61}[a-zA-Z0-9])?\\\\.)+[a-zA-Z]{2,6} |" + // domain
