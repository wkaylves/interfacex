 ...
 */
@Slf4j
public class XXLJobResolverServiceResolver extends BaseServiceResolver {

    public XXLJobResolverServiceResolver(Module module) {
        this.module = module;
    }
    ...
    private static List<InterfaceItem> obtainItemsOnClass(Project project, GlobalSearchScope globalSearchScope) {
        List<InterfaceItem> itemList = new ArrayList<>();
        ...
        for (PsiAnnotation psiAnnotation : psiAnnotations) {
            ...
            list.ifPresent(psiMethod -> {
                itemList.add(createInterfaceItem(psiAnnotation, psiClass, psiMethod));
            });
    ...
    private static @NotNull InterfaceItem createInterfaceItem(PsiAnnotation psiAnnotation, PsiClass psiClass, PsiMethod psiMethod) {
    ...
    private static List<InterfaceItem> obtainItemsOnMethod(Project project, GlobalSearchScope globalSearchScope) {
