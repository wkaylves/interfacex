package com.kaylves.interfacex.module.export.strategy;

import com.kaylves.interfacex.common.annotations.rocketmq.RocketMQListenerSpringAnnotation;
import com.kaylves.interfacex.module.export.bean.RocketMQProducerExportBean;
...
public class RocketMQListenerStrategy implements ServiceStrategy<RocketMQProducerExportBean> {
    ...
    public List<RocketMQProducerExportBean> filter(Project project, Module module, GlobalSearchScope globalSearchScope) {
        Collection<PsiAnnotation> psiAnnotations = JavaAnnotationIndex.getInstance().get(RocketMQListenerSpringAnnotation.RocketMQMessageListener.getShortName(), project, globalSearchScope);
